...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\Experiments\\Lorenzo_Amy_COINS_MEG\\rotation_task_v2 (s001 14-7)\\rotation_task_v2\\rotation_task.py',
...
blocks = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('stimgen/blocks_main4 - 2 P011.csv'),
